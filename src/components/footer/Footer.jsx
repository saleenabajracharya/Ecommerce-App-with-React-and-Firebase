...
<footer class="text-secondary py-3">
    <div class="container px-3 d-flex flex-column flex-md-row align-items-center justify-content-between">
        ...
        <a class="d-flex align-items-center text-white fw-medium text-decoration-none">
            <Link to="/" class="fs-5 text-white text-decoration-none text-uppercase fw-bold">Navbar</Link>
        </a>

        <div class="text-center my-2">
            <small  className="text-white">© Navbar {currentYear}<span id="year"></span></small>
        </div>

        <div class="d-flex flex-column align-items-center align-items-md-end mt-3 mt-md-0">
            <h6 class="fs-6 text-white text-center text-md-end mb-2">Follow Us</h6>
